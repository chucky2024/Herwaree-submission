...
import logo from "../assets/wom2.jpg"; // Ensure the image has a transparent background if needed
  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen relative bg-white overflow-hidden">
      <img
        src={img1}
        alt="Flower Top Left"
        className="absolute -inset-y-6 -left-8 w-32 h-48 transform scale-110 drop-shadow-lg" // Increased size
      />
      <img
        src={img2}
        alt="Flower Top Right"
        className="absolute -inset-y-6 -right-8 w-32 h-48 transform scale-110 drop-shadow-lg" // Increased size
      />
      <div className="text-center z-10 w-full">
        <img src={logo} alt="Herwaree Logo" className="inline-block w-52 h-auto rounded-lg" /> {/* Increased size */}
        <p className="text-purple-500 text-lg mb-10"></p>
        <h1 className="text-purple-500 text-2xl font-bold">Welcome to Breast Health Monitoring</h1> {/* Updated text */}
